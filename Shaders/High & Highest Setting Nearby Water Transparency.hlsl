// Modified by QoL mod: High & Highest Setting Nearby Water Transparency.hlsl
  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (r3.z != 0) {
    ...
    r3.w = t8.Sample(s5_s, r9.yzw).x;
    r4.w = t10.Sample(s6_s, r10.xy).x;
    ...
    if (r4.w != 0) {
      ...
      if (r4.w != 0) {
        ...
        r5.w = t9.Sample(s5_s, r12.xyz).x;
        r6.w = t11.Sample(s6_s, r13.xy).x;

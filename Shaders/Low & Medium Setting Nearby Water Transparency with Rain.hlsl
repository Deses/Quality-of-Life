// Modified by QoL mod: Low & Medium Setting Nearby Water Transparency with Rain.hlsl
  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (cb0[216].x != 0) {
    ...
    r6.xz = r12.wz / r6.xz;
    r0.x = t0.Sample(s12_s, r6.xz).x;
    r0.x = cb1[8].z * r0.x + cb1[8].w;
    r0.x = 1 / r0.x;
    r13.xyzw = t23.Gather(s6_s, r6.xz).xyzw;
    r0.x = r0.x / cb1[6].z;
    r14.x = cb3[9].z;
    r14.y = cb3[10].z;
    r14.z = cb3[11].z;
    ...
    r13.xy = r6.xz + r12.xy;
    r7.x = t21.SampleLevel(s3_s, r13.xy, 0).w;
    r7.x = cmp(r7.x != 1.000000);
    if (r7.x != 0) {
      r6.xz = r6.xz + -r12.xy;
      r7.x = cmp(abs(r11.y) == r0.x);
      if (r7.x != 0) {
        r12.xy = t22.SampleLevel(s6_s, r6.xz, 0, int2(1, 1)).xy;
      } else {
        r7.x = cmp(abs(r11.z) == r0.x);
        if (r7.x != 0) {
          r12.xy = t22.SampleLevel(s6_s, r6.xz, 0, int2(1, 0)).xy;
        } else {
          r7.x = cmp(abs(r11.w) == r0.x);
          if (r7.x != 0) {
            r12.xy = t22.SampleLevel(s6_s, r6.xz, 0, int2(0, 0)).xy;
          } else {
            r12.xy = t22.SampleLevel(s6_s, r6.xz, 0, int2(0, 1)).xy;
          }
        }
      }
      r13.xyzw = t21.SampleLevel(s6_s, r6.xz, 0, int2(0, 1)).xyzw;
      r14.xyzw = t21.SampleLevel(s6_s, r6.xz, 0, int2(1, 1)).xyzw;
      r15.xyzw = t21.SampleLevel(s6_s, r6.xz, 0, int2(1, 0)).xyzw;
      r16.xyzw = t21.SampleLevel(s6_s, r6.xz, 0, int2(0, 0)).xyzw;
  ...
  r0.w = t1.Sample(s2_s, r3.zw).x;
  r2.w = cmp(cb0[204].w == 1.000000);
  r0.w = r2.w ? r0.w : 1;
  r3.zw = float2(25,25) * cb0[76].xy;
  r2.w = cb0[69].w * r5.w;
  r9.yz = r4.xy * r2.ww;
  r13.z = cb1[0].y * cb0[67].y;
  r6.yz = r6.yw * cb0[67].xx + r9.yz;
  ...
  r3.zw = -cb0[194].xy * r6.xx;
  r3.zw = float2(1.44269502,1.44269502) * r3.zw;
  r3.zw = exp2(r3.zw);
  r3.zw = float2(1,1) + -r3.zw;
  r3.zw = max(float2(0,0), r3.zw);
  r6.yzw = cb0[199].xyz + -cb0[192].xyz;
  r6.yzw = cb0[199].www * r6.yzw + cb0[192].xyz;
  ...
  r2.w = cmp(0 != cb0[186].x);
  r3.z = cmp(0 != cb0[141].x);
  r2.w = r2.w ? r3.z : 0;
  if (r2.w != 0) {
    r6.yzw = max(float3(9.99999975e-05,9.99999975e-05,9.99999975e-05), r5.xyz);
    r2.w = cmp(0.5 < cb0[158].w);
    r9.yzw = cb0[177].xyz * v6.yyy;
    r9.yzw = cb0[176].xyz * v6.xxx + r9.yzw;
    r9.yzw = cb0[178].xyz * v6.zzz + r9.yzw;
    r9.yzw = cb0[179].xyz + r9.yzw;
    r3.zw = v6.xz * cb0[184].xy + cb0[184].zw;
    r4.w = t9.Sample(s7_s, r9.yzw).x;
    r3.z = t11.Sample(s8_s, r3.zw).x;
    r3.w = saturate(r4.w * cb0[158].y + cb0[158].z);
    r9.yzw = cb0[159].xyz + -v6.xyz;
    r4.w = dot(r9.yzw, r9.yzw);
    r4.w = sqrt(r4.w);
    r4.w = saturate(r4.w * cb0[159].w + cb0[163].x);
    r9.yzw = cb0[160].xyz + -v6.xyz;
    r5.w = dot(r9.yzw, r9.yzw);
    r5.w = sqrt(r5.w);
    r5.w = saturate(r5.w * cb0[160].w + cb0[163].y);
    r7.w = max(r5.w, r4.w);
    r4.w = min(r5.w, r4.w);
    r4.w = r2.w ? r7.w : r4.w;
    ...
    r5.w = dot(r9.yzw, r9.yzw);
    r5.w = sqrt(r5.w);
    r5.w = saturate(r5.w * cb0[161].w + cb0[163].z);
    r7.w = max(r5.w, r4.w);
    r4.w = min(r5.w, r4.w);
    r4.w = r2.w ? r7.w : r4.w;
    ...
    r5.w = dot(r9.yzw, r9.yzw);
    r5.w = sqrt(r5.w);
    r5.w = saturate(r5.w * cb0[162].w + cb0[163].w);
    r7.w = max(r5.w, r4.w);
    r4.w = min(r5.w, r4.w);
    r2.w = r2.w ? r7.w : r4.w;
    r2.w = r3.w * r2.w;
    ...
    r10.xyz = cb0[170].xyz * r9.yzw + r3.zzz;
    r10.xyz = max(float3(0,0,0), r10.xyz);
    r10.xyz = log2(r10.xyz);
    r13.x = cb0[170].w * r10.x;
    r13.y = cb0[171].w * r10.y;
    r13.z = cb0[172].w * r10.z;
    r10.xyz = exp2(r13.xyz);
    r10.xyz = r10.xyz * cb0[171].xyz + cb0[172].xyz;
    r3.w = cmp(1 < asint(cb0[157].x));
    if (r3.w != 0) {
      r3.w = cmp(r2.w < 0.00196078443);
      if (r3.w != 0) {
        r3.w = cmp(0.5 < cb0[164].w);
        r12.xzw = cb0[181].xyz * v6.yyy;
        r12.xzw = cb0[180].xyz * v6.xxx + r12.xzw;
        r12.xzw = cb0[182].xyz * v6.zzz + r12.xzw;
        r12.xzw = cb0[183].xyz + r12.xzw;
        r13.xy = v6.xz * cb0[185].xy + cb0[185].zw;
        r4.w = t10.Sample(s7_s, r12.xzw).x;
        r5.w = t12.Sample(s8_s, r13.xy).x;
        r4.w = saturate(r4.w * cb0[164].y + cb0[164].z);
        r12.xzw = cb0[165].xyz + -v6.xyz;
        r7.w = dot(r12.xzw, r12.xzw);
        r7.w = sqrt(r7.w);
        r7.w = saturate(r7.w * cb0[165].w + cb0[169].x);
        r12.xzw = cb0[166].xyz + -v6.xyz;
        r10.w = dot(r12.xzw, r12.xzw);
        r10.w = sqrt(r10.w);
        r10.w = saturate(r10.w * cb0[166].w + cb0[169].y);
        r12.x = max(r10.w, r7.w);
        r7.w = min(r10.w, r7.w);
        r7.w = r3.w ? r12.x : r7.w;
        r12.xzw = cb0[167].xyz + -v6.xyz;
        r10.w = dot(r12.xzw, r12.xzw);
        r10.w = sqrt(r10.w);
        ...
        r7.w = min(r10.w, r7.w);
        r7.w = r3.w ? r12.x : r7.w;
        r12.xzw = cb0[168].xyz + -v6.xyz;
        r10.w = dot(r12.xzw, r12.xzw);
        r10.w = sqrt(r10.w);
        r10.w = saturate(r10.w * cb0[168].w + cb0[169].w);
        r12.x = max(r10.w, r7.w);
        r7.w = min(r10.w, r7.w);
        r3.w = r3.w ? r12.x : r7.w;
        r3.w = r4.w * r3.w;
        r2.w = r3.w * r5.w;
        r9.yzw = cb0[173].xyz * r9.yzw + r3.zzz;
        r9.yzw = max(float3(0,0,0), r9.yzw);
        r9.yzw = log2(r9.yzw);
        r13.x = cb0[173].w * r9.y;
        r13.y = cb0[174].w * r9.z;
        r13.z = cb0[175].w * r9.w;
        r9.yzw = exp2(r13.xyz);
  ...
  r10.xyzw = t2.SampleLevel(s13_s, r6.yzw, 0).xyzw;
  r2.w = -1 + r10.w;
  r2.w = cb0[195].w * r2.w + 1;
  r2.w = log2(r2.w);
  r2.w = cb0[195].y * r2.w;
  r2.w = exp2(r2.w);
  r2.w = cb0[195].x * r2.w;
  r6.yzw = r2.www * r10.xyz;
  r3.z = saturate(cb0[197].y * r6.x);
  r3.z = cb0[197].x * r3.z;
  r3.zw = r4.xz * r3.zz + r2.xy;
  r4.xyzw = t18.Sample(s3_s, r3.zw).xyzw;
  r3.z = saturate(cb0[197].z * r4.w);
  r4.xyz = -r2.www * r10.xyz + r4.xyz;
  r4.xyz = r3.zzz * r4.xyz + r6.yzw;
  r2.w = cb0[201].x * cb0[198].x;
  r3.z = cb0[198].y * -r8.x + 1;
  r3.z = max(0.0500000007, r3.z);
  r2.w = r3.z * r2.w;
  r3.z = saturate(cb0[198].z * r6.x);
  ...
  r2.w = t6.Sample(s4_s, r3.zw).x;
  r3.z = r3.x + r3.y;
  r3.z = cb0[74].x * r3.z;
  r3.z = cb0[71].x * cb1[0].y + r3.z;
  r3.w = 1 + -r1.w;
  r3.z = cb0[73].z * r1.w + r3.z;
  r3.z = sin(r3.z);
  r3.z = cb0[73].w * r1.w + r3.z;
  r4.w = r2.w * 2 + -1;
  r3.z = r4.w + r3.z;
  r3.z = cmp(r3.z >= r3.w);
  r3.z = r3.z ? 1.000000 : 0;
  r2.w = r3.z * r2.w;
  r3.z = 9.99999975e-05 + cb0[73].y;
  r3.z = saturate(r0.z / r3.z);
  r3.z = 1 + -r3.z;
  r3.w = cb0[72].w * v1.y;
  r0.w = r3.w * r0.w;
  r0.w = r0.w * r2.w;
  ...
  if (r0.w != 0) {
    ...
    if (r1.w != 0) {
      ...
      if (r1.w != 0) {
        ...
        r3.xyz = cb0[183].xyz + r3.xyz;
        r4.xy = v6.xz * cb0[185].xy + cb0[185].zw;
        r2.w = t10.Sample(s7_s, r3.xyz).x;
        r3.x = t12.Sample(s8_s, r4.xy).x;
        r2.w = saturate(r2.w * cb0[164].y + cb0[164].z);
  ...
  r0.w = r1.z * r1.w + r0.w;
  r2.z = r1.x ? r1.y : r0.w;
  r1.xyzw = t4.Sample(s10_s, r2.xyz).xyzw;

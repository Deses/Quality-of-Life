// Modified by QoL mod: Lowest Setting Nearby Water Transparency with Rain.hlsl
  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (cb0[209].x != 0) {
    ...
    r6.xz = r12.wz / r6.xz;
    r0.x = t0.Sample(s11_s, r6.xz).x;
    r0.x = cb1[8].z * r0.x + cb1[8].w;
    r0.x = 1 / r0.x;
    r13.xyzw = t21.Gather(s5_s, r6.xz).xyzw;
    r0.x = r0.x / cb1[6].z;
    r14.x = cb3[9].z;
    r14.y = cb3[10].z;
    r14.z = cb3[11].z;
    ...
    r13.xy = r6.xz + r12.xy;
    r3.w = t19.SampleLevel(s2_s, r13.xy, 0).w;
    r3.w = cmp(r3.w != 1.000000);
    if (r3.w != 0) {
      r6.xz = r6.xz + -r12.xy;
      r3.w = cmp(abs(r11.y) == r0.x);
      if (r3.w != 0) {
        r12.xy = t20.SampleLevel(s5_s, r6.xz, 0, int2(1, 1)).xy;
      } else {
        r3.w = cmp(abs(r11.z) == r0.x);
        if (r3.w != 0) {
          r12.xy = t20.SampleLevel(s5_s, r6.xz, 0, int2(1, 0)).xy;
        } else {
          r3.w = cmp(abs(r11.w) == r0.x);
          if (r3.w != 0) {
            r12.xy = t20.SampleLevel(s5_s, r6.xz, 0, int2(0, 0)).xy;
          } else {
            r12.xy = t20.SampleLevel(s5_s, r6.xz, 0, int2(0, 1)).xy;
          }
        }
      }
      r13.xyzw = t19.SampleLevel(s5_s, r6.xz, 0, int2(0, 1)).xyzw;
      r14.xyzw = t19.SampleLevel(s5_s, r6.xz, 0, int2(1, 1)).xyzw;
      r15.xyzw = t19.SampleLevel(s5_s, r6.xz, 0, int2(1, 0)).xyzw;
      r16.xyzw = t19.SampleLevel(s5_s, r6.xz, 0, int2(0, 0)).xyzw;
  ...
  if (r0.w != 0) {
    ...
    r2.w = t8.Sample(s6_s, r9.yzw).x;
    r3.z = t10.Sample(s7_s, r10.xy).x;
    ...
    if (r3.z != 0) {
      ...
      if (r3.z != 0) {
        ...
        r4.w = t9.Sample(s6_s, r12.xzw).x;
        r5.w = t11.Sample(s7_s, r13.xy).x;
  ...
  r4.xyzw = t1.SampleLevel(s12_s, r4.xyz, 0).xyzw;
  r0.w = -1 + r4.w;
  ...
  r0.y = (int)r3.z & 1;
  r0.y = (int)r0.y;
  r0.w = t18.Sample(s4_s, r5.xy).x;
  r0.y = r0.y * r0.w;
  r3.xy = cb0[184].yy * r3.xy;
  r0.w = t17.Sample(s4_s, r3.xy).x;
  r1.w = 1 + -r1.w;
  r0.w = r1.w * r0.w;
  r0.y = max(r0.y, r0.w);
  ...
  r0.w = cmp(0 != cb0[61].x);
  if (r0.w != 0) {
    r4.xyzw = cb0[58].xyzw * v6.yyyy;
    r4.xyzw = cb0[57].xyzw * v6.xxxx + r4.xyzw;
    r4.xyzw = cb0[59].xyzw * v6.zzzz + r4.xyzw;
    r4.xyzw = cb0[60].xyzw + r4.xyzw;
    r3.xyz = r4.zxy / r4.www;
    r3.x = saturate(r3.x);
    r0.w = t2.Sample(s1_s, r3.yz).x;
    r1.w = 1 + -r3.x;
  ...
  if (r0.w != 0) {
    ...
    r1.w = t8.Sample(s6_s, r3.xyz).x;
    r2.w = t10.Sample(s7_s, r4.xy).x;
    ...
    if (r1.w != 0) {
      ...
      if (r2.w != 0) {
        ...
        r3.x = t9.Sample(s6_s, r3.xyz).x;
        r3.y = t11.Sample(s7_s, r4.xy).x;
    ...
    if (r1.w != 0) {
      ...
      if (r1.w != 0) {
        ...
        r3.xyz = cb0[167].xyz + r3.xyz;
        r4.xy = v6.xz * cb0[169].xy + cb0[169].zw;
        r2.w = t9.Sample(s6_s, r3.xyz).x;
        r3.x = t11.Sample(s7_s, r4.xy).x;
  ...
  r0.w = t15.SampleLevel(s10_s, r2.xy, 0).x;
  r0.xyz = r0.www * cb0[173].xyz + r0.xyz;
  r0.w = cmp(0.5 < cb0[170].y);
  if (r0.w != 0) {
    r1.xy = (int2)v0.xy;
    r3.xyzw = t14.Gather(s8_s, r2.xy).xyzw;

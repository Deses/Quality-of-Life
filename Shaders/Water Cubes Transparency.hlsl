  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.x = (int)r0.x * 9;
  r1.w = -cb0[154].y + r2.x;
  r1.w = saturate(r1.w / cb0[154].z);
  r3.w = cb0[135].x + -cb0[134].w;
  r1.w = r1.w * r3.w + cb0[134].w;
  r5.xyz = cb6[r0.x+3].xyz + v10.xyz;
  r6.xy = cmp(abs(v11.xy) < float2(0.5,0.5));
  r5.yw = r6.xx ? r5.xy : r5.zy;
  r5.yw = cb0[135].yz * r5.yw;
  r5.xz = cb0[136].xy * r5.xz;
  ...
  r3.w = rsqrt(r3.w);
  r7.xyz = -cb0[153].yzw + r1.yzx;
  r4.w = dot(r7.xyz, r7.xyz);
  r4.w = sqrt(r4.w);
  r5.z = cb0[151].x * r4.w;
  r5.w = r4.w * cb0[151].x + -cb0[151].w;
  r7.x = 1 / cb0[152].x;
  ...
  r7.z = cb0[151].y * r5.z;
  r5.z = -r5.z * cb0[151].y + r7.y;
  r5.z = r5.z * 0.5 + r7.z;
  r7.yz = r6.xz * r3.ww + -r5.zz;
  r7.yz = r7.yz * float2(0.129999995,0.129999995) + r5.zz;
  r8.xy = cb1[0].yy * cb0[150].zw;
  r8.xy = r5.xy * cb0[150].xy + r8.xy;
  r8.xy = frac(r8.xy);
  r7.yz = r8.xy + r7.yz;
  r7.yzw = t0.Sample(s10_s, r7.yz).xyz;
  r5.z = -r7.x * r5.w + 1;
  r7.xyz = r7.yzw * r5.zzz;
  r4.w = -r4.w * cb0[151].x + 1;
  r8.xyz = cb0[152].yzw * r4.www;
  ...
  r8.xyz = -cb0[133].xyz + cb0[132].yzw;
  r10.xyz = cb0[133].xyz + cb0[132].yzw;
  r10.xyz = cb0[134].xyz + r10.xyz;
  ...
  r13.xyz = rcp(r8.xyz);
  r14.xyz = cb0[133].xyz + -r10.xyz;
  r14.xyz = r14.xyz * r13.xyz;
  r15.xyz = cb0[132].yzw + -r10.xyz;
  ...
  r5.w = r6.y ? cb0[116].z : cb0[116].y;
  r6.y = r6.y ? cb0[117].x : cb0[116].w;
  ...
  o0.w = r9.w * r8.w;
  r11.x = saturate(0.0416660011 * cb0[149].x);
  r11.yzw = float3(0.800000012,0.600000024,0.400000006);
  r12.xyz = t2.Sample(s9_s, r11.xy).xyz;
  r8.w = saturate(cb0[157].x * cb0[148].w);
  r12.xyz = r12.xyz * cb0[148].zzz + -cb0[118].xyz;
  r12.xyz = r8.www * r12.xyz + cb0[118].xyz;
  r13.xyz = float3(-1,-1,-1) + r12.xyz;
  r13.xyz = r10.yyy * r13.xyz + float3(1,1,1);
  r9.xyz = r13.xyz * r9.xyz;
  r13.xyz = t2.Sample(s9_s, r11.xz).xyz;
  r13.xyz = r13.xyz * cb0[148].zzz + -cb0[121].xyz;
  r13.xyz = r8.www * r13.xyz + cb0[121].xyz;
  r9.w = cb0[158].z * cb0[119].w;
  r2.x = -cb0[120].y + r2.x;
  r2.x = saturate(r2.x / cb0[120].z);
  r10.z = -cb0[119].w * cb0[158].z + cb0[120].x;
  r2.x = r2.x * r10.z + r9.w;
  r9.w = max(9.99999975e-05, r2.x);
  r9.w = min(1, r9.w);
  r9.xyz = r9.xyz / r9.www;
  r14.xyz = cb0[119].xyz + -r9.xyz;
  ...
  r2.yz = r14.xy + -r8.xy;
  r0.x = cb1[0].y * cb0[155].z;
  r0.x = frac(r0.x);
  r6.xw = r6.xw * cb0[155].ww + r0.xx;
  r2.yz = r2.yz + r16.xy;
  r8.xy = cb0[155].yy * r2.yz;
  r8.xy = r8.xy * cb0[157].zz + r6.xw;
  ...
  if (r2.w == 0) {
    r2.yz = r2.yz + r16.xy;
    r2.yz = cb0[155].yy * r2.yz;
    r2.yz = r2.yz * cb0[157].zz + r6.xw;
    r2.y = t3.Sample(s11_s, r2.yz).x;
    r0.x = r2.y + r0.x;
  }
  r0.x = saturate(r0.x);
  r0.x = 0.00100000005 + r0.x;
  r2.y = cb0[157].y * cb0[154].w;
  r0.x = log2(r0.x);
  r0.x = r2.y * r0.x;
  r0.x = exp2(r0.x);
  r0.x = cb0[155].x * r0.x;
  ...
  r6.xz = r6.xz * r0.xx;
  r0.x = (uint)cb0[138].x;
  r8.xy = cb1[0].yy * cb0[139].zw;
  r8.xy = frac(r8.xy);
  r8.xy = r5.xy * cb0[139].xy + r8.xy;
  r12.xyzw = t4.Sample(s8_s, r8.xy).xyzw;
  r0.x = dot(r12.xyzw, icb[r0.x+0].xyzw);
  r0.x = r0.x * 2 + -1;
  r0.x = r0.x * cb0[138].y + cb0[142].x;
  r5.xy = r6.xz * r0.xx + r5.xy;
  r0.x = (uint)cb0[140].y;
  r6.xz = cb1[0].yy * cb0[141].zw;
  r6.xz = frac(r6.xz);
  r5.xy = r5.xy * cb0[141].xy + r6.xz;
  r12.xyzw = t4.Sample(s8_s, r5.xy).xyzw;
  r0.x = dot(r12.xyzw, icb[r0.x+0].xyzw);
  r0.x = r0.x * v1.z + -cb0[142].y;
  r3.w = cb0[142].z + -cb0[142].y;
  r0.x = saturate(r0.x / r3.w);
  r6.xzw = t2.Sample(s9_s, r11.xw).xyz;
  r6.xzw = r6.xzw * cb0[148].zzz + -cb0[143].xyz;
  r6.xzw = r8.www * r6.xzw + cb0[143].xyz;
  r11.y = 0.200000003;
  r8.xyz = t2.Sample(s9_s, r11.xy).xyz;
  r8.xyz = r8.xyz * cb0[148].zzz + -cb0[147].xyz;
  r8.xyz = r8.www * r8.xyz + cb0[147].xyz;
  r8.xyz = r8.xyz + -r6.xzw;
  r6.xzw = r0.xxx * r8.xyz + r6.xzw;
  r0.x = saturate(cb0[140].x);
  ...
  r1.w = cmp(0.00999999978 < cb0[95].w);
  if (r1.w != 0) {
    r1.w = cmp(cb0[100].y < 0.5);
    if (r1.w != 0) {
      r3.xyz = -cb0[95].xyz + r1.yzx;
      r1.w = dot(r3.xyz, r3.xyz);
      r1.w = sqrt(r1.w);
      r1.w = saturate(r1.w * cb0[97].z + cb0[97].w);
      r1.w = 1 + -r1.w;
      r1.w = r1.w * r1.w;
      r2.w = cmp(cb0[81].w == 1.000000);
      r3.x = cmp(r3.y < 0);
      r2.w = r2.w ? r3.x : 0;
      r1.w = r2.w ? 0 : r1.w;
    } else {
    ...
    r1.w = saturate(cb0[100].z * r1.w);
    r2.w = cmp(cb0[100].x >= 0.0500000007);
    r2.w = r2.w ? 1.000000 : 0;
    r2.w = r2.w * r1.w;
    r3.x = cmp(0.949999988 >= cb0[100].x);
  ...
  r3.x = sqrt(r3.x);
  r3.y = saturate(r3.x * cb0[87].z + cb0[87].w);
  r3.z = saturate(r3.x * cb0[98].z + cb0[98].w);
  r3.z = r3.z + -r3.y;
  r3.y = r2.w * r3.z + r3.y;
  r3.z = 2 + -r3.y;
  r5.x = r3.y * r3.z;
  r3.y = dot(cb0[94].xyzw, float4(1,1,1,1));
  ...
  r2.x = sqrt(r2.x);
  r5.y = saturate(r2.x * cb0[89].x + cb0[89].y);
  r6.y = saturate(cb1[5].y * cb0[89].z + cb0[89].w);
  r2.z = 0.999899983 * cb1[6].z;
  r0.w = cmp(-r0.w >= r2.z);
  r6.x = cb0[86].w * r5.x;
  r6.xy = r0.ww ? r6.xy : r5.xy;
  r0.w = -cb4[0].w + cb0[99].w;
  r0.w = r2.w * r0.w + cb4[0].w;
  r2.z = max(9.99999975e-05, r6.x);
  r2.z = log2(r2.z);
  r0.w = r2.z * r0.w;
  r0.w = exp2(r0.w);
  r2.z = cb0[93].x * cb0[85].w;
  r0.w = min(r2.z, r0.w);
  r0.w = min(1, r0.w);
  r2.z = saturate(v8.w * cb0[87].x + cb0[87].y);
  r3.y = 2 + -r2.z;
  r2.z = r3.y * r2.z;
  r3.yzw = r2.zzz * cb0[86].xyz + cb0[85].xyz;
  r5.xyw = cb0[99].xyz + -r3.yzw;
  r3.yzw = r2.www * r5.xyw + r3.yzw;
  r5.xyw = -r3.yzw + r1.xyz;
  r3.yzw = cb0[94].xxx * r5.xyw + r3.yzw;
  r2.z = -cb0[84].w + r3.x;
  r2.z = saturate(cb0[88].w * r2.z);
  r5.xyw = -cb0[88].xyz + r1.xyz;
  r5.xyw = cb0[94].yyy * r5.xyw + cb0[88].xyz;
  r5.xyw = r5.xyw + -r3.yzw;
  r3.yzw = r2.zzz * r5.xyw + r3.yzw;
  r6.z = saturate(r2.x * cb0[91].z + cb0[91].w);
  r2.x = cb0[96].w + -cb0[83].y;
  r2.x = r1.w * r2.x + cb0[83].y;
  r2.zw = cb0[83].xz * r2.yy;
  r5.xy = cmp(float2(0.00999999978,0.00999999978) < abs(r2.zw));
  r6.xw = -cb0[83].xz * r2.yy + cb0[92].yw;
  r6.xw = min(float2(80,80), r6.xw);
  r6.xw = float2(1.44269502,1.44269502) * r6.xw;
  r6.xw = exp2(r6.xw);
  r6.xw = cb0[92].xz + -r6.xw;
  r2.yz = r6.xw / r2.zw;
  r2.yz = r5.xy ? r2.yz : cb0[92].xz;
  r2.x = r3.x * r2.x;
  r2.x = -r2.y * r2.x;
  r2.x = exp2(r2.x);
  r2.x = 1 + -r2.x;
  r2.x = max(0, r2.x);
  r2.y = saturate(r3.x * cb0[84].x + cb0[84].y);
  r2.w = saturate(r3.x * cb0[97].x + cb0[97].y);
  r2.w = r2.w + -r2.y;
  r2.y = r1.w * r2.w + r2.y;
  r2.w = 2 + -r2.y;
  r4.w = cb0[98].x + -cb0[84].z;
  r4.w = r1.w * r4.w + cb0[84].z;
  r2.y = r2.y * r2.w + -1;
  r2.y = r4.w * r2.y + 1;
  r2.x = r2.x * r2.y;
  r2.x = min(cb0[85].w, r2.x);
  r2.w = cb0[83].w * r3.x;
  r2.z = -r2.z * r2.w;
  r2.z = exp2(r2.z);
  r2.z = 1 + -r2.z;
  r2.z = max(0, r2.z);
  r2.w = saturate(r3.x * cb0[91].x + cb0[91].y);
  r3.x = 2 + -r2.w;
  r2.w = r3.x * r2.w;
  r2.z = r2.z * r2.w;
  r2.y = min(cb0[93].y, r2.z);
  r2.zw = r2.xy * r6.yz;
  r5.xyw = -cb4[0].xyz + cb0[96].xyz;
  r5.xyw = r1.www * r5.xyw + cb4[0].xyz;
  r3.x = cb0[98].y + -cb0[94].z;
  r1.w = r1.w * r3.x + cb0[94].z;
  ...
  r0.w = r2.x * r0.w;
  r1.xyz = -cb0[90].xyz + r1.xyz;
  r1.xyz = cb0[94].www * r1.xyz + cb0[90].xyz;
  r1.w = cb0[82].x * -r2.w + 1;
  r1.xyz = r1.xyz * r2.www;
  r1.xyz = r3.xyz * r1.www + r1.xyz;
  r0.w = r0.w * r2.y;
  r0.xyz = r0.www * r0.xyz + r1.xyz;
  if (r5.z == 0) {
    r0.w = cmp(cb0[81].z == 128.000000);
    r0.w = r0.w ? 16 : 8;
    r0.w = r0.w / cb0[81].z;
    r1.x = cmp(v5.w < 5);
    r1.y = v5.w * r0.w;
    ...
    o0.xyz = r0.www * cb0[109].xyz + r1.xyz;
  } else {
    o0.xyz = r0.xyz;
  }

  ...
  out float4 o0 : SV_Target0)
{
  ...
  r5.w = cmp(cb0[164].x != 0.000000);
  if (r5.w != 0) {
    r5.w = cmp(cb0[37].z == 128.000000);
    r5.w = r5.w ? 16 : 8;
    r5.w = r5.w / cb0[37].z;
    r6.x = cmp(v3.w < 5);
    r8.w = v3.w * r5.w;
    ...
    r9.w = log2(v3.w);
    r9.w = r9.w * 0.150515005 + -0.34948501;
    r11.x = 1 + -r5.w;
    r5.w = r9.w * r11.x + r5.w;
    r2.z = r6.x ? r8.w : r5.w;
    ...
    if (cb0[201].x != 0) {
      ...
      r6.x = cmp(0.00999999978 < cb0[51].w);
      if (r6.x != 0) {
        r6.x = cmp(cb0[56].y < 0.5);
        if (r6.x != 0) {
          r13.xyz = -cb0[51].xyz + r5.yzx;
          r6.x = dot(r13.xyz, r13.xyz);
          r6.x = sqrt(r6.x);
          r6.x = saturate(r6.x * cb0[53].z + cb0[53].w);
          r6.x = 1 + -r6.x;
          r6.x = r6.x * r6.x;
          r8.w = cmp(cb0[37].w == 1.000000);
          r9.w = cmp(r13.y < 0);
          r8.w = r8.w ? r9.w : 0;
          r6.x = r8.w ? 0 : r6.x;
        } else {
        ...
        r6.x = saturate(cb0[56].z * r6.x);
        r8.w = cmp(cb0[56].x >= 0.0500000007);
        r8.w = r8.w ? 1.000000 : 0;
        r8.w = r8.w * r6.x;
        r9.w = cmp(0.949999988 >= cb0[56].x);
      ...
      r9.w = sqrt(r9.w);
      r12.w = saturate(r9.w * cb0[43].z + cb0[43].w);
      r13.x = saturate(r9.w * cb0[54].z + cb0[54].w);
      r13.x = r13.x + -r12.w;
      r12.w = r8.w * r13.x + r12.w;
      r13.x = 2 + -r12.w;
      r13.x = r13.x * r12.w;
      r12.w = dot(cb0[50].xyzw, float4(1,1,1,1));
      ...
      r4.x = sqrt(r4.x);
      r13.y = saturate(r4.x * cb0[45].x + cb0[45].y);
      r5.y = saturate(cb1[5].y * cb0[45].z + cb0[45].w);
      r4.z = 0.999899983 * cb1[6].z;
      r4.z = cmp(-r5.w >= r4.z);
      r5.x = cb0[42].w * r13.x;
      r13.xy = r4.zz ? r5.xy : r13.xy;
      r4.z = -cb4[0].w + cb0[55].w;
      r4.z = r8.w * r4.z + cb4[0].w;
      r5.x = max(9.99999975e-05, r13.x);
      r5.x = log2(r5.x);
      r4.z = r5.x * r4.z;
      r4.z = exp2(r4.z);
      r5.x = cb0[49].x * cb0[41].w;
      r4.z = min(r5.x, r4.z);
      r4.z = min(1, r4.z);
      r5.x = saturate(r5.z * cb0[43].x + cb0[43].y);
      r5.y = 2 + -r5.x;
      r5.x = r5.x * r5.y;
      r5.xyz = r5.xxx * cb0[42].xyz + cb0[41].xyz;
      r15.xyz = cb0[55].xyz + -r5.xyz;
      r5.xyz = r8.www * r15.xyz + r5.xyz;
      r15.xyz = r14.xyz + -r5.xyz;
      r5.xyz = cb0[50].xxx * r15.xyz + r5.xyz;
      r5.w = -cb0[40].w + r9.w;
      r5.w = saturate(cb0[44].w * r5.w);
      r15.xyz = -cb0[44].xyz + r14.xyz;
      r15.xyz = cb0[50].yyy * r15.xyz + cb0[44].xyz;
      r15.xyz = r15.xyz + -r5.xyz;
      r5.xyz = r5.www * r15.xyz + r5.xyz;
      r13.z = saturate(r4.x * cb0[47].z + cb0[47].w);
      r4.x = cb0[52].w + -cb0[39].y;
      r4.x = r6.x * r4.x + cb0[39].y;
      r13.xw = cb0[39].xz * r4.yy;
      r15.xy = cmp(float2(0.00999999978,0.00999999978) < abs(r13.xw));
      r15.zw = -cb0[39].xz * r4.yy + cb0[48].yw;
      r15.zw = min(float2(80,80), r15.zw);
      r15.zw = float2(1.44269502,1.44269502) * r15.zw;
      r15.zw = exp2(r15.zw);
      r15.zw = cb0[48].xz + -r15.zw;
      r13.xw = r15.zw / r13.xw;
      r13.xw = r15.xy ? r13.xw : cb0[48].xz;
      r4.x = r9.w * r4.x;
      r4.x = -r13.x * r4.x;
      r4.x = exp2(r4.x);
      r4.x = 1 + -r4.x;
      r4.x = max(0, r4.x);
      r4.y = saturate(r9.w * cb0[40].x + cb0[40].y);
      r5.w = saturate(r9.w * cb0[53].x + cb0[53].y);
      r5.w = r5.w + -r4.y;
      r4.y = r6.x * r5.w + r4.y;
      r5.w = 2 + -r4.y;
      r8.w = cb0[54].x + -cb0[40].z;
      r8.w = r6.x * r8.w + cb0[40].z;
      r4.y = r4.y * r5.w + -1;
      r4.y = r8.w * r4.y + 1;
      r4.x = r4.x * r4.y;
      r4.x = min(cb0[41].w, r4.x);
      r5.w = cb0[39].w * r9.w;
      r5.w = -r13.w * r5.w;
      r5.w = exp2(r5.w);
      r5.w = 1 + -r5.w;
      r5.w = max(0, r5.w);
      r8.w = saturate(r9.w * cb0[47].x + cb0[47].y);
      r9.w = 2 + -r8.w;
      r8.w = r9.w * r8.w;
      r5.w = r8.w * r5.w;
      r4.y = min(cb0[49].y, r5.w);
      r13.xw = r4.xy * r13.yz;
      r15.xyz = -cb4[0].xyz + cb0[52].xyz;
      r15.xyz = r6.xxx * r15.xyz + cb4[0].xyz;
      r5.w = cb0[54].y + -cb0[50].z;
      r5.w = r6.x * r5.w + cb0[50].z;
      ...
      r4.x = r4.z * r4.x;
      r13.xyz = -cb0[46].xyz + r14.xyz;
      r13.xyz = cb0[50].www * r13.xyz + cb0[46].xyz;
      r4.z = cb0[38].x * -r13.w + 1;
      r13.xyz = r13.xyz * r13.www;
      r5.xyz = r5.xyz * r4.zzz + r13.xyz;
      r4.x = r4.x * r4.y;
    ...
    if (r5.w != 0) {
      ...
      r6.x = cmp(cb0[56].x >= 0.0500000007);
      r6.x = r6.x ? 1.000000 : 0;
      r6.x = r6.x * r5.w;
      r8.w = cmp(0.949999988 >= cb0[56].x);
      r8.w = r8.w ? 1.000000 : 0;
      r5.w = r8.w * r5.w;
    } else {
      r6.x = 0;
    ...
    r8.w = sqrt(r8.w);
    r9.w = saturate(r8.w * cb0[43].z + cb0[43].w);
    r11.x = saturate(r8.w * cb0[54].z + cb0[54].w);
    r11.x = r11.x + -r9.w;
    ...
    r4.x = dot(r4.xz, r4.xz);
    r4.x = sqrt(r4.x);
    r11.y = saturate(r4.x * cb0[45].x + cb0[45].y);
    r5.y = saturate(cb1[5].y * cb0[45].z + cb0[45].w);
    r4.z = 0.999899983 * cb1[6].z;
    r2.z = cmp(-r2.z >= r4.z);
    r5.x = cb0[42].w * r11.x;
    ...
    r2.z = r4.z * r2.z;
    r2.z = exp2(r2.z);
    r4.z = cb0[49].x * cb0[41].w;
    r2.z = min(r4.z, r2.z);
    r2.z = min(1, r2.z);
    r4.z = saturate(r5.z * cb0[43].x + cb0[43].y);
    r5.x = 2 + -r4.z;
    r4.z = r5.x * r4.z;
    r5.xyz = r4.zzz * cb0[42].xyz + cb0[41].xyz;
    r14.xyz = cb0[55].xyz + -r5.xyz;
    r5.xyz = r6.xxx * r14.xyz + r5.xyz;
    r14.xyz = r13.xyz + -r5.xyz;
    r5.xyz = cb0[50].xxx * r14.xyz + r5.xyz;
    r4.z = -cb0[40].w + r8.w;
    r4.z = saturate(cb0[44].w * r4.z);
    r14.xyz = -cb0[44].xyz + r13.xyz;
    r14.xyz = cb0[50].yyy * r14.xyz + cb0[44].xyz;
    r14.xyz = r14.xyz + -r5.xyz;
    r5.xyz = r4.zzz * r14.xyz + r5.xyz;
    r11.z = saturate(r4.x * cb0[47].z + cb0[47].w);
    r4.x = cb0[52].w + -cb0[39].y;
    r4.x = r5.w * r4.x + cb0[39].y;
    r14.xy = cb0[39].xz * r4.yy;
    r14.zw = cmp(float2(0.00999999978,0.00999999978) < abs(r14.xy));
    r4.yz = -cb0[39].xz * r4.yy + cb0[48].yw;
    r4.yz = min(float2(80,80), r4.yz);
    r4.yz = float2(1.44269502,1.44269502) * r4.yz;
    r4.yz = exp2(r4.yz);
    r4.yz = cb0[48].xz + -r4.yz;
    r4.yz = r4.yz / r14.xy;
    r4.yz = r14.zw ? r4.yz : cb0[48].xz;
    r4.x = r8.w * r4.x;
    r4.x = -r4.y * r4.x;
    r4.x = exp2(r4.x);
    r4.x = 1 + -r4.x;
    r4.x = max(0, r4.x);
    r4.y = saturate(r8.w * cb0[40].x + cb0[40].y);
    r6.x = saturate(r8.w * cb0[53].x + cb0[53].y);
    r6.x = r6.x + -r4.y;
    r4.y = r5.w * r6.x + r4.y;
    r6.x = 2 + -r4.y;
    ...
    r4.z = 1 + -r4.z;
    r4.z = max(0, r4.z);
    r6.x = saturate(r8.w * cb0[47].x + cb0[47].y);
    r8.w = 2 + -r6.x;
    r6.x = r8.w * r6.x;
    r4.z = r6.x * r4.z;
    r4.y = min(cb0[49].y, r4.z);
    r14.xy = r4.xy * r11.yz;
    r15.xyz = -cb4[0].xyz + cb0[52].xyz;
    r15.xyz = r5.www * r15.xyz + cb4[0].xyz;
    r4.z = cb0[54].y + -cb0[50].z;
    r4.z = r5.w * r4.z + cb0[50].z;
    ...
    r2.z = r4.x * r2.z;
    r11.xyz = -cb0[46].xyz + r13.xyz;
    r11.xyz = cb0[50].www * r11.xyz + cb0[46].xyz;
    r4.x = cb0[38].x * -r14.y + 1;
    r11.xyz = r11.xyz * r14.yyy;
    r5.xyz = r5.xyz * r4.xxx + r11.xyz;
    r2.z = r2.z * r4.y;
    ...
    r9.xyz = cb0[164].xxx * r4.xyz + r9.xyz;
  }
  r4.xy = r8.xy / r8.zz;
  r2.z = t0.Sample(s9_s, r4.xy).x;
  r2.z = cb1[8].z * r2.z + cb1[8].w;
  ...
  r4.xyz = cb0[175].xyz + -cb0[168].xyz;
  r4.xyz = cb0[175].www * r4.xyz + cb0[168].xyz;
  r4.xyz = float3(-1,-1,-1) + r4.xyz;
  r4.xyz = r0.zzz * r4.xyz + float3(1,1,1);
  r5.xyz = r4.xyz * r9.xyz;
  r6.xyz = cb0[176].xyz + -cb0[169].xyz;
  r6.xyz = cb0[176].www * r6.xyz + cb0[169].xyz;
  ...
  if (r0.z != 0) {
    ...
    r6.xyz = cb0[153].xyz * v5.yyy;
    r6.xyz = cb0[152].xyz * v5.xxx + r6.xyz;
    r6.xyz = cb0[154].xyz * v5.zzz + r6.xyz;
    r6.xyz = cb0[155].xyz + r6.xyz;
    r8.xy = v5.xz * cb0[160].xy + cb0[160].zw;
    r0.w = t6.Sample(s4_s, r6.xyz).x;
    r3.w = t8.Sample(s5_s, r8.xy).x;
    r0.w = saturate(r0.w * cb0[134].y + cb0[134].z);
    r6.xyz = cb0[135].xyz + -v5.xyz;
    r4.w = dot(r6.xyz, r6.xyz);
    r4.w = sqrt(r4.w);
    r4.w = saturate(r4.w * cb0[135].w + cb0[139].x);
    r6.xyz = cb0[136].xyz + -v5.xyz;
    r5.w = dot(r6.xyz, r6.xyz);
    r5.w = sqrt(r5.w);
    r5.w = saturate(r5.w * cb0[136].w + cb0[139].y);
    r6.x = max(r5.w, r4.w);
    r4.w = min(r5.w, r4.w);
    r4.w = r0.z ? r6.x : r4.w;
    r6.xyz = cb0[137].xyz + -v5.xyz;
    r5.w = dot(r6.xyz, r6.xyz);
    r5.w = sqrt(r5.w);
    r5.w = saturate(r5.w * cb0[137].w + cb0[139].z);
    r6.x = max(r5.w, r4.w);
    r4.w = min(r5.w, r4.w);
    r4.w = r0.z ? r6.x : r4.w;
    r6.xyz = cb0[138].xyz + -v5.xyz;
    r5.w = dot(r6.xyz, r6.xyz);
    r5.w = sqrt(r5.w);
    r5.w = saturate(r5.w * cb0[138].w + cb0[139].w);
    r6.x = max(r5.w, r4.w);
    r4.w = min(r5.w, r4.w);
    r0.z = r0.z ? r6.x : r4.w;
    r0.z = r0.w * r0.z;
    ...
    r8.xyz = cb0[146].xyz * r6.xyz + r0.www;
    ...
    r9.z = cb0[148].w * r8.z;
    r8.xyz = exp2(r9.xyz);
    r8.xyz = r8.xyz * cb0[147].xyz + cb0[148].xyz;
    r3.w = cmp(1 < asint(cb0[133].x));
    if (r3.w != 0) {
      r3.w = cmp(r0.z < 0.00196078443);
      if (r3.w != 0) {
        r3.w = cmp(0.5 < cb0[140].w);
        r9.xyz = cb0[157].xyz * v5.yyy;
        r9.xyz = cb0[156].xyz * v5.xxx + r9.xyz;
        r9.xyz = cb0[158].xyz * v5.zzz + r9.xyz;
        r9.xyz = cb0[159].xyz + r9.xyz;
        r11.xy = v5.xz * cb0[161].xy + cb0[161].zw;
        r4.w = t7.Sample(s4_s, r9.xyz).x;
        r5.w = t9.Sample(s5_s, r11.xy).x;
        r4.w = saturate(r4.w * cb0[140].y + cb0[140].z);
        r9.xyz = cb0[141].xyz + -v5.xyz;
        r6.w = dot(r9.xyz, r9.xyz);
        r6.w = sqrt(r6.w);
        r6.w = saturate(r6.w * cb0[141].w + cb0[145].x);
        r9.xyz = cb0[142].xyz + -v5.xyz;
        r8.w = dot(r9.xyz, r9.xyz);
        r8.w = sqrt(r8.w);
        r8.w = saturate(r8.w * cb0[142].w + cb0[145].y);
        r9.x = max(r8.w, r6.w);
        r6.w = min(r8.w, r6.w);
        r6.w = r3.w ? r9.x : r6.w;
        r9.xyz = cb0[143].xyz + -v5.xyz;
        r8.w = dot(r9.xyz, r9.xyz);
        r8.w = sqrt(r8.w);
        r8.w = saturate(r8.w * cb0[143].w + cb0[145].z);
        r9.x = max(r8.w, r6.w);
        r6.w = min(r8.w, r6.w);
        r6.w = r3.w ? r9.x : r6.w;
        r9.xyz = cb0[144].xyz + -v5.xyz;
        r8.w = dot(r9.xyz, r9.xyz);
        r8.w = sqrt(r8.w);
        r8.w = saturate(r8.w * cb0[144].w + cb0[145].w);
        r9.x = max(r8.w, r6.w);
        r6.w = min(r8.w, r6.w);
        r3.w = r3.w ? r9.x : r6.w;
        r3.w = r4.w * r3.w;
        r0.z = r3.w * r5.w;
        r6.xyz = cb0[149].xyz * r6.xyz + r0.www;
        ...
        r9.z = cb0[151].w * r6.z;
        r6.xyz = exp2(r9.xyz);
        r8.xyz = r6.xyz * cb0[150].xyz + cb0[151].xyz;
      }
    }
  ...
  r1.xyzw = cb0[201].xxxx ? r1.xyzw : r4.xyzw;

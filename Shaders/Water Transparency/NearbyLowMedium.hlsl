  ...
  out float4 o0 : SV_Target0)
{
  ...
  r6.xyz = t7.SampleLevel(s3_s, r3.zw, 0).xyz;
  r4.w = -1;
  ...
  if (r0.w != 0) {
    ...
    r1.w = t8.Sample(s5_s, r3.xyz).x;
    r2.w = t10.Sample(s6_s, r4.xy).x;
    ...
    if (r1.w != 0) {
      ...
      if (r2.w != 0) {
        ...
        r3.x = t9.Sample(s5_s, r3.xyz).x;
        r3.y = t11.Sample(s6_s, r4.xy).x;
